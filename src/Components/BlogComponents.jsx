   ...
   <div className="min-h-screen py-20 transition-all duration-1000">
     <div className="container px-4 md:px-0">
       ...
       <div className="mt-14 flex flex-wrap justify-center gap-8">
         {/* Blog Card 1 */}
         <div data-aos="zoom-in" className="relative w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 text-center bg-[#2D3748] hover:bg-[#4A5568] transition-all duration-500 rounded-lg p-6 shadow-lg group">
           ...
           <h2 className="text-[16px] font-bold text-[#36C2CE] transition mt-5"> 20 April 2026 | Front End Design
           </h2>
         ...
         {/* Blog Card 2 */}
         <div data-aos="zoom-in" data-aos-delay="200" className="relative w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 text-center bg-[#2D3748] hover:bg-[#4A5568] transition-all duration-500 rounded-lg p-6 shadow-lg group">
         ...
         {/* Blog Card 3 */}
         <div data-aos="zoom-in"data-aos-delay="400"className="relative w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 text-center bg-[#2D3748] hover:bg-[#4A5568] transition-all duration-500 rounded-lg p-6 shadow-lg group">
