  ...
  return (
    ...
    <div className="container mx-auto px-4 py-10 mt-[60px] min-h-screen">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-blue-500  ">MD. Jahidul Islam</h1>
          <div className="text-lg md:text-xl text-blue-500">
            <Typewriter
              options={{
          ...
          <div>
          <p className="text-[#36C2CE] text-base md:text-lg font-medium max-w-md mx-auto md:mx-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mt-4">
            <Link to="/about">
            <button className="px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:scale-105 hover:bg-blue-400 transition"> View Work
            </button>
            </Link>
            <Link to="/contact">
            <button className="px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:scale-105 hover:bg-blue-400 transition"> Contact Me
            </button>
            </Link>
            </div>
          <div>
          <h2 className="text-md md:text-lg font-semibold mt-6 text-[hsl(189,100%,56%)]"> Trusted by World Leading Brands <br /> Portfolio!
          </h2>
          </div>
          </div>
        ...
        <div className="relative flex flex-col items-center md:w-1/2 pt-10">
          ...
          <div className="mt-6 text-center space-y-2">
            <h3 className="text-xl md:text-2xl font-bold text-[#578FCA]">MD. Jahidul Islam</h3>
            <div className="text-lg md:text-xl font-semibold text-[#578FCA]">
              <Typewriter
                options={{
